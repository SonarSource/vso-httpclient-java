...
public abstract class BuildHttpClientBase
    ...
    */
    ...
    /** 
     * [Preview API 3.1-preview.3] Associates an artifact with a build
     * 
     * @param artifact 
     *            
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.3] Gets a specific artifact for a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.3] Gets all artifacts for a build
     * 
     * @param buildId 
     *            
    ...
    /** 
     * [Preview API 3.1-preview.3] Deletes a build
     * 
     * @param buildId 
     *            
     */
    ...
    /** 
     * [Preview API 3.1-preview.3] Gets a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.3] Gets builds
     * 
     * @param project 
     *            Project ID or project name
     * @param definitions 
    ...
    /** 
     * [Preview API 3.1-preview.3] Queues a build
     * 
     * @param build 
     *            
    ...
    /** 
     * [Preview API 3.1-preview.3] Updates a build
     * 
     * @param build 
     *            
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.3] Update a batch of builds
     * 
     * @param builds 
     *            
     * @return ArrayList&lt;Build&gt;
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets the changes associated with a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets the changes associated between given builds
     * 
     * @param project 
     *            Project ID or project name
     * @param fromBuildId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets a controller
     * 
     * @param controllerId 
     *            
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets controller, optionally filtered by name
     * 
     * @param name 
     *            
    ...
    /** 
     * [Preview API 3.1-preview.2] Creates a new definition
     * 
     * @param definition 
     *            
    ...
    /** 
     * [Preview API 3.1-preview.2] Deletes a definition and all associated builds
     * 
     * @param definitionId 
     *            
     */
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets a definition, optionally at a specific revision
     * 
     * @param project 
     *            Project ID or project name
     * @param definitionId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets definitions, optionally filtered by name
     * 
     * @param project 
     *            Project ID or project name
     * @param name 
    ...
    /** 
     * [Preview API 3.1-preview.2] Updates an existing definition
     * 
     * @param definition 
     *            
     * @param definitionId 
    ...
    /** 
     * [Preview API 3.1-preview.1] Creates a new folder
     * 
     * @param folder 
     *            
     * @param project 
    ...
    /** 
     * [Preview API 3.1-preview.1] Deletes a definition folder for given folder name and path and all it&#039;s existing definitions and it&#039;s corresponding builds
     * 
     * @param project 
     *            Project ID or project name
     * @param path 
    ...
    /** 
     * [Preview API 3.1-preview.1] Gets folders
     * 
     * @param project 
     *            Project ID or project name
     * @param path 
    ...
    /** 
     * [Preview API 3.1-preview.1] Updates an existing folder at given  existing path
     * 
     * @param folder 
     *            
     * @param project 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets a log
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets logs for a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.1] Gets metrics of a definition
     * 
     * @param project 
     *            Project ID or project name
     * @param definitionId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets report for a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets revisions of a definition
     * 
     * @param project 
     *            Project ID or project name
     * @param definitionId 
    ...
    /** 
     * [Preview API 3.1-preview.1] Updates the build settings
     * 
     * @param settings 
     *            
     * @return BuildSettings
    ...
    /** 
     * [Preview API 3.1-preview.2] Adds a tag to a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Adds tag to a build
     * 
     * @param tags 
     *            
     * @param project 
    ...
    /** 
     * [Preview API 3.1-preview.2] Deletes a tag from a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets the tags for a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.1] Deletes a definition template
     * 
     * @param project 
     *            Project ID or project name
     * @param templateId 
    ...
    /** 
     * [Preview API 3.1-preview.1] Gets definition template filtered by id
     * 
     * @param project 
     *            Project ID or project name
     * @param templateId 
    ...
    /** 
     * [Preview API 3.1-preview.1] Saves a definition template
     * 
     * @param template 
     *            
     * @param project 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets details for a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets the work item ids associated with a build
     * 
     * @param project 
     *            Project ID or project name
     * @param buildId 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets the work item ids associated with build commits
     * 
     * @param commitIds 
     *            
     * @param project 
    ...
    /** 
     * [Preview API 3.1-preview.2] Gets all the work item ids inbetween fromBuildId to toBuildId
     * 
     * @param project 
     *            Project ID or project name
     * @param fromBuildId 
